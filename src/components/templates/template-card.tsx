...
const typeConfig: Record<TemplateType, { label: string; color: string }> = {
  initial: { label: 'Initial Outreach', color: 'bg-blue-100 text-blue-700' },
  followup: { label: 'Follow-up', color: 'bg-purple-100 text-purple-700' },
  intro_request: { label: 'Intro Request', color: 'bg-cyan-100 text-cyan-700' },
  update: { label: 'Update', color: 'bg-green-100 text-green-700' },
};
